...
# Importer la MASTER_LIST générée dynamiquement par le scraper# Importer la MASTER_LIST générée dynamiquement par le scraper

from master_list_generated import MASTER_LISTfrom master_list_generated import MASTER_LIST

    {"name": "67", "rarity": "Common", "spawn_weight": 40},

# === PRIX DE BASE ===    {"name": "Admin Lucky Block", "rarity": "Common", "spawn_weight": 40},

RARITY_VALUES = {    {"name": "Agarrini La Palini", "rarity": "Common", "spawn_weight": 40},

    "Common": 100,    {"name": "Alessio", "rarity": "Common", "spawn_weight": 40},

    "Rare": 500,    {"name": "Anpali Babel", "rarity": "Common", "spawn_weight": 40},

    "Epic": 1500,    {"name": "Antonio", "rarity": "Common", "spawn_weight": 40},

    "Legendary": 5000,    {"name": "Aquanut", "rarity": "Common", "spawn_weight": 40},

    "God": 20000    {"name": "Avocadini Antilopini", "rarity": "Common", "spawn_weight": 40},

}    {"name": "Avocadini Guffo", "rarity": "Common", "spawn_weight": 40},

    {"name": "Avocadorilla", "rarity": "Common", "spawn_weight": 40},

# === VARIANTES ET MUTATIONS ===    {"name": "Ballerina Cappuccina", "rarity": "Common", "spawn_weight": 40},

TYPE_MULTIPLIERS = {"Normal": 1.0, "Gold": 1.5, "Diamond": 2.5}    {"name": "Ballerino Lololo", "rarity": "Common", "spawn_weight": 40},

TYPE_WEIGHTS = [80, 15, 5]  # pour random.choices    {"name": "Bambini Crostini", "rarity": "Common", "spawn_weight": 40},

    {"name": "Bambu Bambu Sahur", "rarity": "Common", "spawn_weight": 40},

MUTATION_MULTIPLIERS = {"None": 1.0, "Minor": 1.2, "Major": 1.6, "Mythic": 2.0}    {"name": "Bananita Dolphinita", "rarity": "Common", "spawn_weight": 40},

MUTATION_WEIGHTS = [70, 20, 8, 2]    {"name": "Bananito Bandito", "rarity": "Common", "spawn_weight": 40},

    {"name": "Bandito Axolito", "rarity": "Common", "spawn_weight": 40},

# === JOURNAL DE SPAWN ===    {"name": "Bandito Bobritto", "rarity": "Common", "spawn_weight": 40},

spawn_log = []    {"name": "Belula Beluga", "rarity": "Common", "spawn_weight": 40},

    {"name": "Bisonte Giuppitere", "rarity": "Common", "spawn_weight": 40},

# === FONCTION DE SPAWN ===    {"name": "Blackhole Goat", "rarity": "Common", "spawn_weight": 40},

def spawn_brainrot():    {"name": "Blueberrinni Octopusini", "rarity": "Common", "spawn_weight": 40},

    # Sélection pondérée de l'objet    {"name": "Bombardini Tortinii", "rarity": "Common", "spawn_weight": 40},

    selected = random.choices(MASTER_LIST, weights=[b["spawn_weight"] for b in MASTER_LIST], k=1)[0]    {"name": "Bombardiro Crocodilo", "rarity": "Common", "spawn_weight": 40},

        {"name": "Bombombini Gusini", "rarity": "Common", "spawn_weight": 40},

    # Sélection du type et mutation (également pondérée)    {"name": "Boneca Ambalabu", "rarity": "Common", "spawn_weight": 40},

    type_selected = random.choices(list(TYPE_MULTIPLIERS.keys()), weights=TYPE_WEIGHTS, k=1)[0]    {"name": "Brainrot God Lucky Block", "rarity": "Common", "spawn_weight": 40},

    mutation_selected = random.choices(list(MUTATION_MULTIPLIERS.keys()), weights=MUTATION_WEIGHTS, k=1)[0]    {"name": "Brasilini Berimbini", "rarity": "Common", "spawn_weight": 40},

        {"name": "Brr Brr Patapim", "rarity": "Common", "spawn_weight": 40},

    # Calcul du prix    {"name": "Brr es Teh Patipum", "rarity": "Common", "spawn_weight": 40},

    base_value = RARITY_VALUES[selected["rarity"]]    {"name": "Brri Brri Bicus Dicus Bombicus", "rarity": "Common", "spawn_weight": 40},

    final_price = base_value * TYPE_MULTIPLIERS[type_selected] * MUTATION_MULTIPLIERS[mutation_selected]    {"name": "Bruto Gialutto", "rarity": "Common", "spawn_weight": 40},

    final_price = round(final_price, 2)    {"name": "Buho De Fuego", "rarity": "Common", "spawn_weight": 40},

        {"name": "Bulbito Bandito Traktorito", "rarity": "Common", "spawn_weight": 40},

    # Enregistrement    {"name": "Burbaloni Luliloli", "rarity": "Common", "spawn_weight": 40},

    spawn_info = {    {"name": "Burguro And Fryuro", "rarity": "Common", "spawn_weight": 40},

        "name": selected["name"],    {"name": "Burrito Bandito", "rarity": "Common", "spawn_weight": 40},

        "rarity": selected["rarity"],    {"name": "Cacasito Satalito", "rarity": "Common", "spawn_weight": 40},

        "type": type_selected,    {"name": "Cachorrito Melonito", "rarity": "Common", "spawn_weight": 40},

        "mutation": mutation_selected,    {"name": "Cacto Hipopotamo", "rarity": "Common", "spawn_weight": 40},

        "price": final_price    {"name": "Capi Taco", "rarity": "Common", "spawn_weight": 40},

    }    {"name": "Capitano Moby", "rarity": "Common", "spawn_weight": 40},

    spawn_log.append(spawn_info)    {"name": "Cappuccino Assassino", "rarity": "Common", "spawn_weight": 40},

        {"name": "Cappuccino Clownino", "rarity": "Common", "spawn_weight": 40},

    # Affichage en temps réel    {"name": "Caramello Filtrello", "rarity": "Common", "spawn_weight": 40},

    print(f"🧠 {selected['name']} | {selected['rarity']} | {type_selected} | {mutation_selected} → 💰 {final_price}$")    {"name": "Carloo", "rarity": "Common", "spawn_weight": 40},

        {"name": "Carrotini Brainini", "rarity": "Common", "spawn_weight": 40},

# === BOUCLE DE SIMULATION ===    {"name": "Cavallo Virtuoso", "rarity": "Common", "spawn_weight": 40},

def simulate_spawns(duration_seconds=20):    {"name": "Celularcini Viciosini", "rarity": "Common", "spawn_weight": 40},

    print("=== Simulation de Spawn Brainrot ===")    {"name": "Chachechi", "rarity": "Rare", "spawn_weight": 25},

    num_spawns = duration_seconds // 2  # toutes les 2 secondes    {"name": "Chef Crabracadabra", "rarity": "Rare", "spawn_weight": 25},

    for _ in range(num_spawns):    {"name": "Chicleteira Bicicleteira", "rarity": "Rare", "spawn_weight": 25},

        spawn_brainrot()    {"name": "Chicleteirina Bicicleteirina", "rarity": "Rare", "spawn_weight": 25},

        time.sleep(2)    {"name": "Chihuanini Taconini", "rarity": "Rare", "spawn_weight": 25},

        {"name": "Chillin Chili", "rarity": "Rare", "spawn_weight": 25},

    # Export JSON    {"name": "Chimpanzini Bananini", "rarity": "Rare", "spawn_weight": 25},

    with open("brainrot_spawn_log.json", "w", encoding="utf-8") as f:    {"name": "Chimpanzini Spiderini", "rarity": "Rare", "spawn_weight": 25},

        json.dump(spawn_log, f, ensure_ascii=False, indent=4)    {"name": "Chipso and Queso", "rarity": "Rare", "spawn_weight": 25},

    print("\n✅ Journal exporté dans brainrot_spawn_log.json")    {"name": "Cocofanto Elefanto", "rarity": "Rare", "spawn_weight": 25},

    {"name": "Cocosini Mama", "rarity": "Rare", "spawn_weight": 25},

# === LANCEMENT ===    {"name": "Combinasions", "rarity": "Rare", "spawn_weight": 25},

if __name__ == "__main__":    {"name": "Corn Corn Corn Sahur", "rarity": "Rare", "spawn_weight": 25},

    print(f"📊 MASTER_LIST: {len(MASTER_LIST)} brainrots chargés")    {"name": "Crabbo Limonetta", "rarity": "Rare", "spawn_weight": 25},

    simulate_spawns(20)    {"name": "Developini Braziliaspidini", "rarity": "Rare", "spawn_weight": 25},
